...
fcl.config({
  ...
  "app.detail.title": "F1_NFTs", // Change the title!
    ...
    try {
      const transactionId = await fcl.mutate({
        ...
        args: (arg, t) => [
          ...
          arg("F1 NFT # "+_id.toString(), types.String), // Name
          arg("F1 NFT's in Flow Blockchain", types.String), // Description
          arg("ipfs://bafybeiajsxge3visrcg4bhaaj7p3yh4grkcflcy4keffb7gktg7zue6yui/"+_id+".png", types.String),
        ],
      ...
      <div className="container">
        <div className="header-container">
          <div className="logo-container">
            ...
            <p className="header">✨Awesome F1 NFTs on Flow ✨</p>
          </div>
